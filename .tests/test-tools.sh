...
if [[ $is_windows_os ]]; then
  ...
  test_stdout "$curl --version" "curl 7.81.0 (x86_64-pc-linux-musl) libcurl/7.81.0 OpenSSL/3.0.1 (Schannel) zlib/1.2.11 brotli/1.0.9 libidn2/2.3.2 libssh2/1.10.0 nghttp2/1.46.0 libgsasl/1.10.0
  Release-Date: 2022-01-05
